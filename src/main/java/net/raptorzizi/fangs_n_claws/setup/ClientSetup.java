...
import net.raptorzizi.fangs_n_claws.entity.scorpion.FrostScorpionRenderer;
import net.raptorzizi.fangs_n_claws.entity.scorpion.NetherScorpionRenderer;
...
public class ClientSetup {
    ...
    public static void rendererRegister(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityRegistry.DESERT_SCORPION.get(),  DesertScorpionRenderer::new);
        event.registerEntityRenderer(EntityRegistry.FROST_SCORPION.get(),   FrostScorpionRenderer::new);
        event.registerEntityRenderer(EntityRegistry.NETHER_SCORPION.get(),  NetherScorpionRenderer::new);
