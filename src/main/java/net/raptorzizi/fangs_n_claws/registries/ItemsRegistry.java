...
public class ItemsRegistry {
    ...
    public static final RegistryObject<ForgeSpawnEggItem> PURPLE_WORM_SPAWN_EGG = ITEMS.register("purple_worm_spawn_egg",
            () -> new ForgeSpawnEggItem(EntityRegistry.PURPLE_WORM, 0x5a2d82, 0x9b59b6, new Item.Properties().stacksTo(64)));
