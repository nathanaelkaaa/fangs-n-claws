...
public class WildWolfModel extends GeoModel<WildWolfEntity> {
    ...
    private static ResourceLocation tex(String name) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "textures/entity/" + name + ".png");
    }

    @Override
    public ResourceLocation getModelResource(WildWolfEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "geo/wild_wolf.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(WildWolfEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "animations/wild_wolf.animation.json");
    }
