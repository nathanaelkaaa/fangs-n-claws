...
public class WildWolfEntity extends Monster implements GeoEntity {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(VARIANT, VARIANT_BLACK);
    ...
    public SpawnGroupData finalizeSpawn(@NotNull ServerLevelAccessor level, @NotNull DifficultyInstance difficulty,
            @NotNull MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag dataTag) {
    ...
    // 1.20.1 : par défaut un passager est placé à height*0.75, donc le goblin-cavalier s'enfonce
    // dans le dos du loup. En 1.21.1, EntityAttachments place le passager au sommet de la bbox ;
    // on réplique ce comportement en renvoyant la hauteur complète.
    @Override
