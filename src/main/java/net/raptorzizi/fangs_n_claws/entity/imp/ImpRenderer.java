...
public class ImpRenderer extends GeoEntityRenderer<ImpEntity> {
    ...
    private static final ResourceLocation EYES =
            FangsClawsMod.id("textures/entity/glowing_eyes/imp_eyes.png");
    ...
    public ImpRenderer(EntityRendererProvider.Context context) {
        ...
        this.addRenderLayer(new GeoRenderLayer<>(this) {
            @Override
            public void render(PoseStack poseStack, ImpEntity animatable, BakedGeoModel bakedModel,
        ...
        this.addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            ...
            @Override
            public void renderForBone(PoseStack poseStack, ImpEntity animatable, GeoBone bone,
                ...
                super.renderForBone(poseStack, animatable, bone, renderType, bufferSource,
