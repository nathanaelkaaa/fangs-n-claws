...
public class PurpleWormModel extends GeoModel<PurpleWormEntity> {
    ...
    public ResourceLocation getModelResource(PurpleWormEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "geo/purple_worm.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(PurpleWormEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "textures/entity/purple_worm.png");
    }

    @Override
    public ResourceLocation getAnimationResource(PurpleWormEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "animations/purple_worm.animation.json");
    }
