...
public class PurpleWormArmModel extends GeoModel<PurpleWormArmEntity> {
    ...
    public ResourceLocation getModelResource(PurpleWormArmEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "geo/purple_worm_arm.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(PurpleWormArmEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "textures/entity/purple_worm_arm.png");
    }

    @Override
    public ResourceLocation getAnimationResource(PurpleWormArmEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "animations/purple_worm_arm.animation.json");
    }
}
