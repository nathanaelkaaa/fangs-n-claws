...
public class FireGhostModel extends GeoModel<FireGhostEntity> {
    ...
    private static final ResourceLocation NORMAL_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "textures/entity/fire_ghost.png");
    private static final ResourceLocation ANGRY_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "textures/entity/angry_fire_ghost.png");
    ...
    public ResourceLocation getModelResource(FireGhostEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "geo/fire_ghost.geo.json");
    }
