...
public class HorseArmorMenu extends AbstractContainerMenu {
    ...
    public static HorseArmorMenu fromNetwork(int containerId, Inventory playerInv, RegistryFriendlyByteBuf buf) {
    ...
    public boolean stillValid(Player player) {
        return this.container.stillValid(player) && this.horse.isAlive() && player.canInteractWithEntity(this.horse, 4.0);
    }
