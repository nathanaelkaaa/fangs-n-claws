...
public class SkeletonHorseTrapMobGoal extends Goal {
    ...
    private SkeletonHorseMob createHorse(DifficultyInstance difficulty) {
        ...
        if (mount != null) {
            mount.finalizeSpawn((ServerLevel) this.horse.level(), difficulty, MobSpawnType.TRIGGERED, null);
    ...
    private Skeleton createSkeleton(DifficultyInstance difficulty, AbstractHorse mount) {
        ...
        if (skeleton != null) {
            skeleton.finalizeSpawn((ServerLevel) mount.level(), difficulty, MobSpawnType.TRIGGERED, null);
