...
public class DartGoblinModel extends GeoModel<DartGoblinEntity> {
    ...
    public ResourceLocation getModelResource(DartGoblinEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "geo/dart_goblin.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(DartGoblinEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "textures/entity/dart_goblin.png");
    }

    @Override
    public ResourceLocation getAnimationResource(DartGoblinEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(FangsClawsMod.MOD_ID, "animations/dart_goblin.animation.json");
    }
