...
public class FurArmorItem extends ArmorItem implements GeoItem {
    ...
    public static final ArmorMaterial MATERIAL = new ArmorMaterial() {
        ...
        @Override
        public Ingredient getRepairIngredient() { return Ingredient.of(ItemsRegistry.FUR.get()); }

        @Override
        public String getName() { return "fur"; }
    ...
    public FurArmorItem(ArmorItem.Type type, int durability) {
